  ...
  return (
    <StyledSection>
      ...
      <SubSection>
        ...
        <p>
          I speak perfectly French because it’s my mother tongue (I come from
          New Caledonia), I also speak English, not perfectly but enough for
          work but I stammer when i am stressed. I can say some love words in at
          least 10 different languages, it’s useless but it can help during a
          date.
        </p>
      </SubSection>
      <SubSection>
